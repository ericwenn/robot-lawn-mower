...
class camera(object):
    ...
    def split_image(self, image_path, split_x=None, split_y=None, split_save_path=None):
    ...
    def closeness_to_green(self, color):
    ...
    def analyzeSection(self, splits, start, stop):
        yCoord = 0
        breaks = False
        mx = stop - start
        my = len(splits[0])
